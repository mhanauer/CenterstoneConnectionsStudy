...
## Try employment employment not significant
modelLogit2  = glmer(LivingWhere.y ~  Employment.x + (1 | ClientID), data  = ConnGPRAAnalysis, family = "binomial")
summary(modelLogit2)

## Try HealthStatus.x, not significant
modelLogit3  = glmer(LivingWhere.y ~  HealthStatus.x + (1 | ClientID), data  =ConnGPRAAnalysis , family = "binomial")
summary(modelLogit3)

## ArrestedDays.x
modelLogit4  = glmer(LivingWhere.y ~  ArrestedDays.x + (1 | ClientID), data  = ConnGPRAAnalysis, family = "binomial")
summary(modelLogit4)

## Try EducationYears.x, not significant
modelLogit5 = glmer(LivingWhere.y ~  EducationYears.x + (1 | ClientID), data  = ConnGPRAAnalysis, family = "binomial")
summary(modelLogit5)

### Try Depression.x, not significant 
modelLogit6 = glmer(LivingWhere.y ~  Depression.x  + (1 | ClientID), data  = ConnGPRAAnalysis, family = "binomial")
summary(modelLogit6)
...
### Try Anxiety.x, not significant
modelLogit7 = glmer(LivingWhere.y ~  Anxiety.x  + (1 | ClientID), data  = ConnGPRAAnalysis, family = "binomial")
summary(modelLogit7)
...
### DAUseIllegDrugsDays.x, not significant
modelLogit9 = glmer(LivingWhere.y ~  DAUseIllegDrugsDays.x + (1 | ClientID), data  = ConnGPRAAnalysis, family = "binomial")
summary(modelLogit9)

### Get rid of missing values for PHQ9_GAD7

### Try PHQ9, not significant 
modelLogit10 = glmer(LivingWhere.y ~  PHQ9Base + (1 | ClientID), data  = PHQ9_GAD7Analysis, family = "binomial")
summary(modelLogit10)


### Try GAD7Base
modelLogit11 = glmer(LivingWhere.y ~  GAD7Base + (1 | ClientID), data  = PHQ9_GAD7Analysis, family = "binomial")
summary(modelLogit11)
