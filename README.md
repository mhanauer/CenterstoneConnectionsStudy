...
TestMCARNormality(PHQ9_GAD7Long)
dim(PHQ9_GAD7Long)
dim(subset(PHQ9_GAD7Long, time == 0))

PHQ9_GAD7LongComplete = na.omit(PHQ9_GAD7Long)
dim(subset(PHQ9_GAD7LongComplete, time == 0))
...
confint.merMod(model1, parm = "beta_", method = "boot")
